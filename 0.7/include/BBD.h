...
typedef struct {
    ...
    int puntuacion_repartidor;
    int puntuacion_entrega;
    char comentario[500];
    char fecha_calificacion[11];
    int fue_recomendado;
    char estado_resenia[20];
} Calificacion;
...
typedef struct {
    ...
    double monto_comision;
    double monto_neto;
    char fecha_comision[11];
    char estado[20];
} ComisionDetalle;

typedef struct {
    int id_pago_restaurante;
    int id_restaurante;
    double monto_total;
    char fecha_pago[11];
    char metodo_pago[50];
