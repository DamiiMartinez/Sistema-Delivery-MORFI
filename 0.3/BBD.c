...
void panelEncargador(Usuario usuario){
    ...
    do{
        ...
        switch(opcion){
            ...
            case 4:{
                system("cls");
                printf("\n[INFO] Órdenes pendientes (funcionalidad en desarrollo)\n");
                system("pause");
                system("cls");
                break;
            }
            case 5:{
                system("cls");
                printf("\n[INFO] Pedidos (funcionalidad en desarrollo)\n");
                system("pause");
                system("cls");
                break;
            }
            case 6:{
                system("cls");
                printf("\n[INFO] Información del restaurante (funcionalidad en desarrollo)\n");
                system("pause");
                system("cls");
                break;
            }
            case 7:{
                system("cls");
                printf("\n[INFO] Modificar datos (funcionalidad en desarrollo)\n");
                system("pause");
                system("cls");
                break;
            }
            case 8:{
                system("cls");
                printf("\n[INFO] Eliminar cuenta (funcionalidad en desarrollo)\n");
                system("pause");
                system("cls");
                break;
            }
